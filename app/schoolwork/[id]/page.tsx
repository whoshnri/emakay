// app/schoolwork/[id]/page.tsx
import { Metadata } from 'next';

// This function would normally fetch data from the database
async function getSchoolWorkItem(id: string) {
  // Mock data until the database is connected
  return {
    id,
    title: `Schoolwork Item ${id}`,
    description: `This is a detailed description of schoolwork item ${id}.`,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const item = await getSchoolWorkItem(params.id);
